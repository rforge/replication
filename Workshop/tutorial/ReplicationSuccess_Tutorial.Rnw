...
abline(a = 0, b = 1, 
       col = "lightpink")
axis(1, las = 1, at = c(0.01, 0.1,1,10), labels = c("1/100", "1/10","1","10"))
axis(2, las = 1, at = c(0.01, 0.1,1,10), labels = c("1/100", "1/10","1","10"))
...
abline(a = 0, b = 1, 
       col = "lightpink")
axis(1, las = 1, at = c(0.01, 0.1, 1, 10, 50), labels = c("1/100", "1/10", "1", "10", "50"))
axis(2, las = 1, at = c(0.01, 0.1, 1, 10, 50), labels = c("1/100", "1/10", "1", "10", "50"))
@
