...
@
    ...
    \item Original effect estimates is sometimes shrunken by a factor of 50\%.
...
pow.condshrink <- powerSignificance(zo = p2z(pval.or, alternative = "one.sided"), 
                              c = 1, designPrior = "conditional", shrinkage=0.75)
...
ss.condshrink <- sampleSizeSignificance(zo = p2z(pval.or, alternative = "one.sided"), 
                              power=0.8, designPrior = "conditional", shrinkage=0.75)
